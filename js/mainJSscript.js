$(document).ready(function(){	
    ...
    $(".item_form").submit(function(e){
        ...
        $.ajax({
            ...
            $("#cart_update_info").append("<div id='new_item_added'><img src='images/cart-2.png' style='padding-bottom: 5px;'>Item added to the cart</div>").fadeIn('fast').delay(2000).fadeOut('fast');
