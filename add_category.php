...
$queryInsertCategory = "INSERT INTO menuitems (menuName) VALUES (:np_category_name)";
        ...
        <script>$(document).ready(function ()
{
    ...
    <body> 
        ...
        <div class="logo" style="background-color: white;">
            <a href='add_category_form.php'><h1 style="color: black; font-size: 20px;" >Add new Brand</h1></a>
            &nbsp;
      </div>
