...
<div class="row">
              <div id="tm-section-1" class="tm-section">
                <div class="col-md-12">
                    <h1 class="text-xs-center blue-text tm-title">Registration 
</h1>          
                </div>
              </div>    
  ...
  <section id="tm-section-4" class="tm-section">
                    <div class="tm-container">
                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
                            <form action="register_new_user_transaction.php" method="post" class="tm-contact-form">                                
                                ...
                                <input type="submit" class="btn tm-light-blue-bordered-btn pull-xs-right" value="Register New User"><br>
                            </form>   
                        </div> <!-- col -->
