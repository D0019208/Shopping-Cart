        ...
        <script>$(document).ready(function ()
{
    ...
    <body> 
        ...
        <div class="logo" style="background-color: white;">
            ...
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
      <a href='delete_product_form.php'><h1 style="color: black; font-size: 20px;" onclick="">Delete Item</h1></a>
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
      <a href='update_product_form.php'><h1 style="color: black; font-size: 20px;" onclick="">Update Item</h1></a>
      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
      <a href='add_category_form.php'><h1 style="color: black; font-size: 20px;" onclick="">Add New Brand</h1></a>
      </div>
